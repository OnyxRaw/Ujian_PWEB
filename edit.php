...
<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
    Data Complete CRUD Application
  </nav>
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" name="last_name" placeholder="Computer Science">
            </div>

            <div class="form-group mb-3">
               <label>Hobby:</label>
               &nbsp;
               <input type="text" class="form-control" name="gender" placeholder="Reading, Coding, etc.">
            </div>
